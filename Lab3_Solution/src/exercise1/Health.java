...
public class Health extends Insurance {
    ...
    // implements the setInsuranceCost method of the superclass
    @Override
    public void setInsuranceCost(double monthlyInsuranceCost) {
        super.typeOfInsurance = "Health";
    ...
    public void displayInfo() {
        ...
        JOptionPane.showMessageDialog(
                ...
                "You have a " + super.getTypeOfInsurance() + " insurance"
                        + "\nYour total monthly cost is " + dollarFormat.format(super.getMonthlyInsuranceCost()),    // get the formatted currency
                "Information",
